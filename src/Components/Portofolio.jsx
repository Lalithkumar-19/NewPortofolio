...
function Portofolio() {
    ...
    const projects = [

        {
            ...
            Description: "This is the landing page of a simple Blog website ,build by taking task from frontendmentor.com to leverage my frontend skills.Built with Semantic HTML5 marku ,CSS custom properties,Flexbox, CSS Grid ,Mobile-first workflow",
            domain: "Frontend",
            ...
            codeLink: "https://github.com/Lalithkumar-19/responsive_css_page?tab=readme-ov-file",
            liveLink: "https://lalithkumar-19.github.io/responsive_css_page/",
            Description: "This is the small project i had worked on in my initial days of learning web ,task was taken from frontend mentor website .",
            domain: "Frontend",
            ...
            Description: "SpaceX Clone, a web application designed to mirror the official SpaceX website using HTML, CSS, and JavaScript. Immerse yourself in the world of space exploration and innovation, just like on the official SpaceX site.",
            domain: "Frontend",
        },
        {
        ...
        },
        {
            ...
            Description: "This is fullstack app ,I learned MONGODB CRUD operations with node js and express js by building this project alone.",
            domain: "Fullstack"
    ...
    return (
        <div className='flex flex-col w-full text-[white] p-4' id='portofolio'>
            ...
            <div className='flex w-full flex-wrap  items-center justify-center gap-7 mt-3'>
                ...
                {projects.map((item, i) => {
                    return (
                        <div  key={i}className='flex w-[350px] flex-col hover:border p-3 rounded-md cursor-pointer h-[600px]' data-aos="slide-left">
                            <img src={item.pic} alt='portofolio' className='w-full h-[200px] rounded-lg' />
                            <div className='flex flex-col w-full'>
                                <h2 className='mt-2 p-2 text-justify text-[green] font-bold w-full h-12'>{item.project_Name}</h2>
                                ...
                                <div className='w-full flex items-center justify-center gap-2 mt-2 bg-slate-800 rounded-md'>
                                    <a role='button' className='bg-white text-black text-2xl p-2 rounded-md hover:bg-[#00df9a] hover:text-black' href={item.codeLink}>Code</a>
                                    <a role='button' className='bg-white text-black text-2xl p-2 rounded-md hover:bg-[#00df9a] hover:text-black' href={item.liveLink}>See live</a>
                                </div>
            ...
            <a role='button' className='bg-white text-2xl p-2 rounded-md hover:bg-[#00df9a] hover:text-black text-center text-cyan-800 w-[80%] mt-6 mx-auto' href={"https://github.com/Lalithkumar-19"}>SEE ALL ON GITHUB</a>
