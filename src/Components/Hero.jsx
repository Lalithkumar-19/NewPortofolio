  ...
  return (
    <div className="text-white" id="hero">
      <div className="max-w-[800px] mt-[100px] w-full h-screen mx-auto text-center flex flex-col">
        ...
        <div>
          <p className="md:text-5xl sm:text-4xl text-xl font-bold mt-3">
            {" "}
            Hard working and Passionated in
          </p>
          <ReactTyped
        ...
        <p className="md:text-xl text-xl font-bold text-gray-500 ">
          Hire me to get work with you and experience my professional working
          style.
        </p>
        <button className="bg-[#00df9a] w-[200px] rounded-full font-medium my-6 mx-auto py-3 text-black">
          <AnchorLink href="#msg_me">Get me a coffe</AnchorLink>
        </button>
      </div>
    </div>
  );
